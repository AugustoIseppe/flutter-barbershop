...
class BarberDetails extends StatelessWidget {
  const BarberDetails({super.key, required this.barber, required this.barbershop});
          ...
          Container(
            ...
            // color: Colors.blue,
              image: DecorationImage(
                image: NetworkImage("http://10.0.2.2:8800/users/uploads/${barber['barberimage']}"),
                fit: BoxFit.cover,
              ),
            ),
          ),
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Row(
                            children: [
                              SocialMediaButton.whatsapp(
                                url: "https://wa.me/${barber["barberwhatsapp"]}",
                                color: colorsPalletes.white,
                                size: 18,
                              ),
                              Text(
                          ...
                          Row(
                            children: [
                              Icon(Iconsax.call, color: colorsPalletes.white, size: 18),
                              Text(
                                " ${(barbershop.phones)}",
                                style: TextStyle(
                                  fontSize: 15,
