...
class ColorsPalletes {
  ...
  Color senaryColor = const Color(0xffDC2F02);
  Color septenaryColor = const Color(0xffE85D04);
  Color octonaryColor = const Color(0xffF48C06);
  Color nonaryColor = const Color(0xffFAA307);
  Color denaryColor = const Color(0xffFFBA08);
